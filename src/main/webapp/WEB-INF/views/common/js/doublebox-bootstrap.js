(function($, window, document, undefined) {
    ...
    BootstrapDualListbox.prototype = {
        ...
        disabled:function (value,refresh) {
            if (value) {
                this.elements.select1.prop("disabled", "true");
                this.elements.select2.prop("disabled", "true");
                ...
                this.elements.select1.removeAttr("disabled");
                this.elements.select2.removeAttr("disabled");
                this.elements.moveAllButton.removeAttr("disabled");
                this.elements.moveButton.removeAttr("disabled");
                this.elements.removeButton.removeAttr("disabled");
                this.elements.removeAllButton.removeAttr("disabled");
            }
            if (refresh) {
                refreshSelects(this)
            }
