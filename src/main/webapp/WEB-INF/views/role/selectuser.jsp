        ...
        <div class="panel">
            <div class="table-responsive">
                <table class="table table-hover manage-u-table" style="white-space: nowrap">
                    ...
                    <tbody>
                    <c:forEach items="${checkedUsers}" var="user">
                        <tr>
                            <td>${user.id}</td>
                            ...
                            <td>
                                <div>
                                    <div style="display: inline-block; width:50%">
                                        <input type="button" class="btn btn-block btn-info btn-xs" value="移除" onclick="remove(${user.id},${roleId});"/>
                                    </div>
                                    &nbsp;
                                </div>
                            </td>
...
<script type="text/javascript">
    ...
    function skipPage1(page) {
        ...
        var url = "${pageContext.request.contextPath}/role/selectuser";
