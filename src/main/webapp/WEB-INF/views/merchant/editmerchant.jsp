...
<head>
    ...
    <link href="../common/adm/plugins/bower_components/dropzone-master/dist/dropzone.css" rel="stylesheet"  type="text/css" >
                            ...
                            <div class="col-md-8">
                                <form id="form" onsubmit="update();return false;" class="form-material form-horizontal" data-toggle="validator">
                                    <div class="form-group">
                                        <label class="col-md-12"><label style="color: #f05b4f">*</label>&nbsp;商户ID</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="hidden" name="id"  class="form-control" value="${merchant.id}" />
                                            <input type="text" name="company" maxlength="50" required="required" placeholder="请输入商户公司名称" data-error="请填写商户公司名称"  class="form-control" value="${merchant.company}" />
                                            <div class="help-block with-errors"></div>
                                            <input type="hidden" name="licenseImg" id="liceimg"  class="form-control" value="${merchant.licenseImg}" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="description" maxlength="200" class="form-control"
                                                      rows="5">${merchant.description}</textarea>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(function(){
        $(".dropzone").dropzone({
            ...
            init: function() {
                if("${merchant.licenseImg}"!="null"){
                    var licenseimg = "${merchant.licenseImg}";
