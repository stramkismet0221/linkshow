                            ...
                            <td>
                                <div>
                                    <div style="display: inline-block; width:50%">
                                        <input type="button" class="btn btn-block btn-info btn-xs" value="移除" onclick="remove(${user.id},${powerId});"/>
                                    </div>
                                    &nbsp;
                                </div>
                            </td>
...
<script type="text/javascript">
    ...
    function skipPage1(page) {
        ...
        var url = "${pageContext.request.contextPath}/power/selectuser";
    ...
    // 移除
    function remove(userId,powerId) {
        swal({
            title: "确定移除吗?",
            ...
            if (isConfirm) {
                $.ajax({
                    url : "${pageContext.request.contextPath}/power/deluserpower",
                    type : "POST",
                    dataType : "json",
