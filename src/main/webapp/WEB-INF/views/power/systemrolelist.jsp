        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">加入角色</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="#">权限管理</a></li>
                        <li class="active">加入角色</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                        ...
                        <form id="search">
                            <div class="row">
                                <div class="col-md-12" style="width:100%; display: inline">
                                    <h5 style="width: 50%;display: inline">所属系统：<label style="font-weight: 600">${systemInfo.name}</label></h5>
                                    &nbsp;&nbsp;&nbsp;
                                    <h5 style="width: 50%;display: inline">所属权限：<label style="font-weight: 600">${powerName}</label></h5>
                                </div>
                                ...
                                <div class="col-md-4" style="width:17%">
                                    <h5 class="m-t-30 m-b-10">角色编码</h5>
                                    <input type="text" class="form-control" id="code" maxlength="50" placeholder="请输入角色编码" value="${role.code}"/>
                                </div>
                                ...
                                <div class="col-md-4" style=" width:10%">
                                    <h5 class="m-t-30 m-b-10">&nbsp;</h5>
                                    <input type="button" class="btn btn-block btn-info" value="返回" onclick="location.href='${pageContext.request.contextPath}/power/getpowerlist'"/>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    ...
    function loadPowerRoles() {
        ...
        var name = $("#name").val();
        var code = $("#code").val();
        var data = {systemId:systemId,powerId:powerId,name:name,code:code};
        $.ajax({
            type: "POST",
            async: false,
            url: "${pageContext.request.contextPath}/power/unselectrole",
            dataType: "html",
            data: data,
            beforeSend:function () {
        ...
        $.ajax({
            type: "POST",
            async: false,
            url: "${pageContext.request.contextPath}/power/selectrole",
            dataType: "html",
            data: data,
            beforeSend:function () {
                var contentPath = "${pageContext.request.contextPath}";
