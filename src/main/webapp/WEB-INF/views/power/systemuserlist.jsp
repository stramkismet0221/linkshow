        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">加入用户</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="#">权限管理</a></li>
                        <li class="active">加入用户</li>
                    </ol>
                </div>
            </div>
            <div class="row">
...
<script type="text/javascript">
    ...
    function loadPowerUsers() {
        ...
        var data = {systemId:systemId,powerId:powerId,userName:userName,realName:realName};
        $.ajax({
            type: "POST",
            async: false,
            url: "${pageContext.request.contextPath}/power/unselectuser",
            dataType: "html",
            data: data,
            beforeSend:function () {
        ...
        $.ajax({
            type: "POST",
            async: false,
            url: "${pageContext.request.contextPath}/power/selectuser",
            dataType: "html",
            data: data,
            beforeSend:function () {
                var contentPath = "${pageContext.request.contextPath}";
