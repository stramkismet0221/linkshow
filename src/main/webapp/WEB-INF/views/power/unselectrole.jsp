...
<form id="unSelectform">
    ...
    <div class="white-box">
        <h3 class="box-title m-b-0">未选择角色</h3>
        <div class="row">
        </div>
        <div class="panel">
            <div class="table-responsive">
                <table class="table table-hover manage-u-table" style="white-space: nowrap">
                    ...
                    <tbody>
                    <c:forEach items="${unCheckedRoles}" var="role">
                        <tr>
                            <td>${role.id}</td>
                            <td title="${role.name}">
                            ...
                            <td>
                                <div>
                                    <div style="display: inline-block; width:50%">
                                        <input type="button" class="btn btn-block btn-info btn-xs" value="加入" onclick="addRolePower(${role.id});"/>
                                    </div>
                                    &nbsp;
                                </div>
                            </td>
...
<script type="text/javascript">
    ...
    function skipPage(page) {
        ...
        var url = "${pageContext.request.contextPath}/power/unselectrole";
    ...
    //权限加入角色
    function addRolePower(roleId) {
        $.ajax({
            url : "${pageContext.request.contextPath}/power/addrolepower",
            type : "POST",
            dataType : "json",
