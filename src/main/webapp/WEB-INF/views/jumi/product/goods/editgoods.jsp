                            ...
                            <div class="col-md-8">
                                <form id="form" onsubmit="save();return false;" class="form-horizontal form-material" data-toggle="validator" novalidate="true">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="barCode" maxlength="25"
                                                   class="form-control" placeholder="请输入条码"  value="${goods.barCode}"/>
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" name="code" maxlength="25"
                                                   class="form-control" placeholder="请输入商家自编码" value="${goods.code}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <c:if test="${goods.type == 1 || goods.type == 2}">
                                            <div class="col-md-6">
                                                <input type="text" name="name"  maxlength="50" placeholder="请输入商品名称" class="form-control" value="${goods.name}"/>
                                            </div>
                                        </c:if>
                                        <c:if test="${goods.type == 4}">
                                            <div class="col-md-6">
                                                <input type="text" name="name"  maxlength="50" placeholder="请输入材料名称" class="form-control" value="${goods.name}"/>
                                            </div>
                                        </c:if>
                                        <div class="col-md-6">
                                            <input type="text" name="shortCode" maxlength="25" placeholder="请输入拼音简码" class="form-control" value="${goods.shortCode}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="specs" maxlength="10"
                                                   class="form-control" placeholder="请输入规格型号" value="${goods.specs}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="price"  maxlength="10"
                                                       class="form-control" placeholder="请输入零售价" value="${goods.priceStr==null?no:goods.priceStr}" onkeyup="btnonkeyupDiscountfour(this,value)"/>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="tradePrice"  maxlength="10"
                                                       class="form-control" placeholder="请输入批发价"  value="${goods.tradePriceStr==null?no:goods.tradePriceStr}" onkeyup="btnonkeyupDiscountfour(this,value)"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="onlinePrice" maxlength="10"
                                                       class="form-control" placeholder="请输入网店价"  value="${goods.onlinePriceStr==null?no:goods.onlinePriceStr}" onkeyup="btnonkeyupDiscountfour(this,value)"/>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="terminalPrice"  maxlength="10"
                                                       class="form-control" placeholder="请输入设备价" value="${goods.terminalPriceStr==null?no:goods.terminalPriceStr}" onkeyup="btnonkeyupDiscountfour(this,value)"/>
                                            </div>
                                        </div>
                                    </c:if>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="costPrice" maxlength="10"
                                                   class="form-control" placeholder="请输入成本价" value="${goods.costPriceStr==null?no:goods.costPriceStr}" onkeyup="btnonkeyupDiscountfour(this,value)"/>
                                        </div>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/jumi/product/goods/updategoods",
                    type: "POST",
                    dataType: "json",
                    data: $("#form").serialize(),
                    success: function (result) {
                        if (result.success) {
                            swal({
                                ...
                                location.href = "${pageContext.request.contextPath}/jumi/product/goods/getlist?type=" + result.extInfo.type;
                            });
                        } else {
                            swal({
                                title: result.msg,
