        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title"> 商品品牌添加</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="#"> 商品品牌管理</a></li>
                        <li class="active"> 商品品牌添加</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="col-md-8">
                                <form id="form" onsubmit="save();return false;" class="form-horizontal form-material" data-toggle="validator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="name" maxlength="100" required="required" placeholder="请输入品牌名称" data-error="请输入品牌名称" class="form-control" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="linkUrl" maxlength="80"  placeholder="请输入品牌链接"  class="form-control" />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="description" maxlength="250" class="form-control" rows="5" placeholder="请输入品牌简介" ></textarea>
                                        </div>
                                    </div>
                                ...
                                <%--<div class="row">--%>
                                    <%--<div class="col-lg-4"></div>--%>
                                    <%--<div class="col-lg-2 col-sm-4 col-xs-12">--%>
                                        <%--<button class="btn btn-block btn-info text-uppercase waves-effect waves-light" onclick="save()"  >--%>
                                            <%--<span style="vertical-align: inherit;">保存</span>--%>
                                        <%--</button>--%>
                                    <%--</div>--%>
                                    <%--<div class="col-lg-2 col-sm-4 col-xs-12">--%>
    ...
    function save() {
        ...
        swal({
            ...
            if (isConfirm) {
                // ajax提交
                $.ajax({
                    url: "${pageContext.request.contextPath}/jumi/product/goodsbrands/add",
                    type: "POST",
                    dataType: "json",
                    async: false,
                    data: $("#form").serialize(),
