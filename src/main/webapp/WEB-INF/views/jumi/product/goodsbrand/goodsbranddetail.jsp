        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">商品品牌详情</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="#">商品品牌管理</a></li>
                        <li class="active">商品品牌详情</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="col-md-8">
                                <form id="form" class="form-material form-horizontal" data-toggle="validator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" class="form-control" value="${goodsbrand.name}" disabled/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">排序</label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control" value="${goodsbrand.sno}" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" class="form-control" value="${goodsbrand.linkUrl}" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="description" maxlength="255" class="form-control" rows="5"  disabled>${goodsbrand.description}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">品牌图标</label>
                                        <div class="col-md-12">
                                            <c:forTokens items="${goodsbrand.logo}" delims="," var="liceimg">
