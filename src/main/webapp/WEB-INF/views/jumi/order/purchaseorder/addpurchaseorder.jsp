                            ...
                            <div class="col-md-8">
                                <form id="form" onsubmit="save();return false;" class="form-horizontal form-material" data-toggle="validator" novalidate="true">
                                                ...
                                                <div class="radio-list">
                                                    <label class="radio-inline">
                                                        <div class="radio radio-info">
                                                            <input type="radio" name="businessType" id="r1" value="1" checked>
                                                            <label for="r1">购货</label>
                                                        </div>
                                                    </label>
                                                    <label class="radio-inline">
                                                        <div class="radio radio-info">
                                                            <input type="radio" name="businessType" id="r2" value="3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="poDateStr" maxlength="50" placeholder="请输选择单据日期" class="form-control datepicker-autoclose"/>
                                        </div>
                                    </div>
                                    <c:if test="${type != 3}">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="giveTimeStr" maxlength="50" placeholder="请输选择交货日期日期" class="form-control datepicker-autoclose"/>
                                            </div>
                                        </div>
                                    </c:if>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="discountRate" maxlength="10" placeholder="请输入优惠率" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">&nbsp;优惠金额</label>
                                        <div class="col-md-12">
                                            <input rows="5" name="discountPrice" maxlength="10" placeholder="请输入优惠金额" class="form-control"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">&nbsp;优惠后金额</label>
                                        <div class="col-md-12">
                                            <input rows="5" name="discountAfterPrice" maxlength="10" placeholder="请输入优惠后金额" class="form-control"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">&nbsp;备注</label>
                                        <div class="col-md-12">
                                            <textarea rows="5" name="remark" maxlength="300" placeholder="请输入备注" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
...
<script type="text/javascript">
    ...
    function save() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/jumi/order/purchaseorder/addpurchaseorder",
                    type: "POST",
                    dataType: "json",
                    data: $("#form").serialize(),
                    success: function (result) {
                        if (result.success) {
                            swal({
                                ...
                                location.href = "${pageContext.request.contextPath}/jumi/order/purchaseorder/getlist?type=${type}";
                            });
                        } else {
                            swal({
                                title: result.msg,
