                            ...
                            <div class="col-md-8">
                                <form id="form" onsubmit="save();return false;" class="form-horizontal form-material" data-toggle="validator" novalidate="true">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="name" required="required" maxlength="50" placeholder="请输入单位名称" data-error="请输入单位名称" class="form-control" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="sno" required="required" onkeyup="btnonkeyup(this,value)" maxlength="4" placeholder="请输入排序" data-error="请输入排序" class="form-control" />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="row">
...
<script type="text/javascript">
    function save() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/jumi/drp/goodsunit/insertjmgoodsunit",
                    type: "POST",
                    dataType: "json",
                    data: date,
                    success: function (result) {
