        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">商品单位列表</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="#">商品单位中心</a></li>
                        <li class="active">商品单位列表</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <div class="row">
                            <div class="col-md-3" >
                                <h5 class="m-t-30 m-b-10">单位名称</h5>
                                <input type="text" class="form-control" id="ename" maxlength="100" placeholder="请输入单位名称" value="${jmGoodsUnit.name}"/>
                            </div>
                            <div class="col-md-1">
            ...
            <form action="${pageContext.request.contextPath}/jumi/drp/goodsunit/getlist" id="form">
                        ...
                        <div class="white-box">
                            <div class="row">
                                <div class="col-lg-1 col-md-2 col-sm-4 col-xs-4">
                                    <input type="button" value="新建" class="btn btn-block btn-info" onclick="location.href='${pageContext.request.contextPath}/jumi/drp/goodsunit/toaddjmgoodsunit'"/>
                                </div>
                            </div>
                            <div class="panel">
                                                    ...
                                                    <div>
                                                        <div style="display: inline-block; width:28%">
                                                            <input type="button" style="background-color: green" data-toggle="modal" data-target=".bs-example-modal-lg" class="btn btn-block btn-primary btn-xs" value="详情"
                                                                   onclick="location.href='${pageContext.request.contextPath}/jumi/drp/goodsunit/jmgoodsunitinfo?id=${data.id}&type=0'" />
                                                        </div>
                                                        &nbsp;
                                                        <div style="display: inline-block; width:28%">
                                                            <input type="button" class="btn btn-block btn-info btn-xs" value="修改"
                                                                   onclick="location.href='${pageContext.request.contextPath}/jumi/drp/goodsunit/jmgoodsunitinfo?id=${data.id}&type=1'"/>
                                                        </div>
                                                        &nbsp;
                                                        <div style="display: inline-block; width:28%">
...
<script type="text/javascript">
    function remove(id) {
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/jumi/drp/goodsunit/deljmgoodsunit",
                    type: "POST",
                    dataType: "json",
                    data: {"jmGoodsUnitId": id},
