                                ...
                                <form id="form" onsubmit="update();return false;" class="form-material form-horizontal" data-toggle="validator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="name" onkeyup="btnonkeyupspace(this, value);" maxlength="50" required="required" placeholder="请输入仓库名称" data-error="请输入仓库名称" class="form-control"  value="${warehouse.name}"  disabled/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="code" disabled onkeyup="btnonkeyupspace(this, value);" maxlength="20"  placeholder="请输入仓库编号" data-error="请输入仓库编号" class="form-control"  value="${warehouse.code}" />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="radio radio-info" style="display: inline-block; margin-left: 15px; margin-right: 5%;">
                                            <input type="radio" name="status" id="radio1" <c:if test="${warehouse.status==1}">checked=""</c:if> disabled value="1">
                                            <label for="radio1"> 开启 </label>
                                        </div>
                                        <div class="radio radio-info" style="display: inline-block; margin-right: 5%;">
                                            <input type="radio" name="status" id="radio2" <c:if test="${warehouse.status==2}">checked=""</c:if> value="2" disabled >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio radio-info" style="display: inline-block; margin-left: 15px; margin-right: 5%;">
                                            <input type="radio" name="isFirst" id="radio3" <c:if test="${warehouse.isFirst==1}">checked=""</c:if> disabled  value="1">
                                            <label for="radio3" style="padding-right:12px;"> 是 </label>
                                        </div>
                                        <div class="radio radio-info" style="display: inline-block; margin-right: 5%;">
                                            <input type="radio" name="isFirst" id="radio4" <c:if test="${warehouse.isFirst==0}">checked=""</c:if> disabled value="0"  >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="storage" disabled onkeyup="btnonkeyupspace(this, value);" maxlength="50"  placeholder="请输入存储条件" data-error="请输入存储条件" class="form-control"  value="${warehouse.storage}" />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-2" style="padding-left:0px">
                                                <select id="provinceid" name="provinceId" onchange="setcity(this)" class="form-control" disabled >
                                            ...
                                            <div class="col-md-2">
                                                <select id="cityid" name="cityId" onchange="setdistrict(this)"  class="form-control" disabled >
                                            ...
                                            <div class="col-md-2">
                                                <select id="districtid" name="districtId"  class="form-control" disabled >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12" title="${warehouse.detailAddress}">
                                            <input type="text" name="detailAddress" disabled onkeyup="btnonkeyupspace(this, value);" maxlength="100"  placeholder="请输入详细地址" data-error="请输入详细地址" class="form-control"  value="${warehouse.detailAddress}" />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
