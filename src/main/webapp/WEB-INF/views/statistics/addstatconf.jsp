        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">新增统计</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="#">数据中心</a></li>
                        <li class="active">新增统计</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="col-md-8">
                                <form id="form"  onsubmit="save();return false;" class="form-material form-horizontal" data-toggle="validator">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="name" maxlength="50" required="required"  placeholder="请输入统计名称" data-error="请输入统计名称"  class="form-control" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="url"  maxlength="1500"  required="required"  placeholder="请输入链接地址" data-error="请输入链接地址" class="form-control" />
                                        </div>
                                    </div>
...
<script type="text/javascript">
    function save() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url : "${pageContext.request.contextPath}/statistics/addstatconf",
                    type : "POST",
                    dataType : "json",
                    data : $("#form").serialize(),
