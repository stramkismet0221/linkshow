        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title"> 新增渠道商</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="#"> 渠道商列表</a></li>
                        <li class="active"> 新增渠道商</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <form id="form" onsubmit="save();return false;" class="form-horizontal form-material"
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12"><label
                                                style="color: #f05b4f">*</label>&nbsp;联系人</label>
                                        <div class="col-md-12">
                                            <input type="text" name="contacts" required="required" maxlength="20"
                                                   placeholder="请输入联系人" data-error="请输入联系人" class="form-control"/>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea id="remark" name="remark" maxlength="200" class="form-control" rows="5" placeholder="请输入备注"></textarea>
                                        </div>
                                    </div>
    ...
    function save() {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                param.remark = remark
                $.ajax({
                    url: "${pageContext.request.contextPath}/smoke/addAgent",
                    type: "POST",
                    dataType: "json",
                    data: param,
