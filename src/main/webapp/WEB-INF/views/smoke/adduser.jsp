                            ...
                            <div class="col-md-2"></div>
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12" for="agentId"><label style="color: #f05b4f">*</label>&nbsp;渠道商名称</label>
                                        <div class="col-sm-12">
                                            <c:if test="${sellSmokeAgent != null}">
                                            ...
                                            <select class="form-control" id="agentId" name="agentId">
                                                ...
                                                <option value="${data.id}" ${data.id==agentId?"selected":""}>${data.name}</option>
                                                </c:forEach>
                                            </select>
                                            </c:if>
                                        </div>
...
<script type="text/javascript">
    function save() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/smoke/getusercountbyusername",
                    type: "POST",
                    dataType: "json",
                    ...
                    success: function (result) {
                        if (result <= 0) {
                            $.ajax({
                                url: "${pageContext.request.contextPath}/smoke/insertuser",
                                type: "POST",
                                dataType: "json",
                                data: $("#form").serialize(),
                                success: function (result) {
