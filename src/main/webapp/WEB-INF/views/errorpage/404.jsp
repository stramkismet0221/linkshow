...
<head>
    ...
    <!-- color CSS -->
    <link href="${pageContext.request.contextPath}/common/adm/css/colors/default.css" id="theme" rel="stylesheet">
...
<section id="wrapper" class="error-page">
    <div class="error-box">
        <div class="error-body text-center">
            ...
            <a href="javascript: history.go(-1);" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Back
                to home</a></div>
